...
export default function ExplorePanel({
  ...
  function addDimension(field) {
    if (!field) return
    if (dimensions.includes(field)) return
    setConfig((prev) => ({ ...prev, dimensions: [...prev.dimensions, field] }))
  }

  function removeDimension(field) {
    setConfig((prev) => ({ ...prev, dimensions: prev.dimensions.filter((x) => x !== field) }))
  }
      ...
      <div className="content-grid">
        <div className="panel glass">
          <div className="panel-header">
            ...
            <span className="small-muted">выбор полей, логики, фильтров и вида графика</span>
          </div>
          ...
          <div className="builder-block">
            ...
            <div className="builder-grid-2">
              <SearchSelect
                ...
                placeholder="Выбери поле для группировки"
              />
            ...
            {!!dimensions.length && (
              <div className="chip-grid selected-dimensions">
                {dimensions.map((field) => (
                  <button key={field} className="select-chip active" onClick={() => removeDimension(field)}>
                    {field} ×
                  </button>
                ))}
              </div>
          ...
          <div className="builder-block">
            <div className="builder-title">2. Метрика и визуал</div>
            ...
            <div className="builder-grid-3">
              <SearchSelect
                ...
                placeholder="Выбери тип метрики"
              />
              ...
              <SearchSelect
                ...
                options={chartTypes}
                placeholder="Выбери тип визуала"
              />
            </div>
...
`}
        ...
        <ChartCard title="Предпросмотр визуала" data={chartData} mode={config.chartMode} />
      </div>
